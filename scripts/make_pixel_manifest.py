"""Write isolated, budget-matched visual OGBench benchmark manifests."""
...
def main():
    ...
    print(f'Wrote {len(rows)} isolated visual benchmark runs to {output}')
