...
LEGACY_ALIASES = {
    'gc_mscp': 'gc_mscp_style',
    'passive_hiql': 'hiql_endpoint_online',
    'gc_oso_decqn': 'gc_oso_decqn_factorized',
    'gc_rlpd': 'gc_sac_50_50',
}


DEFAULT_OFFLINE_STEPS = {
    'pbf_online_idm': 1_000_000,
    'gc_mscp_style': 1_000_000,
    'hiql_endpoint_online': 1_000_000,
    'gc_af_guide': 50_000,
    'gc_oso_decqn_factorized': 3_000_000,
    'gc_sac': 0,
    'gc_td3': 0,
    'gc_sac_50_50': 1_000_000,
}
...
def create_algorithm(
    ...
    *,
    ...
    if name in ('gc_sac', 'gc_td3', 'gc_sac_50_50'):
...
def algorithm_metadata(name: str) -> AlgorithmMetadata:
    ...
    records = {
        'pbf_online_idm': dict(
            ...
            implementation_notes='Frozen deterministic-prefix PBF; online optimization updates only a new IDM.',
        ),
        'gc_mscp_style': dict(
        ...
        'hiql_endpoint_online': dict(
            ...
            official_repo_commit=None,
            online_modules_updated=('low_policy', 'value'),
            implementation_notes='HIQL-inspired endpoint hierarchy with an online low-level policy.',
        ),
        'gc_af_guide': dict(
            port_kind='goal_conditioned_adaptation',
        ...
        'gc_sac_50_50': dict(
            ...
            implementation_notes='GC-SAC with symmetric 50:50 offline/online replay; not RLPD (no large critic ensemble or high UTD recipe).',
        ),
    }
