...
def pixel_algorithm_metadata(name: str) -> AlgorithmMetadata:
    ...
    records = {
        ...
        'vip_finetuned_gc_drqv2': dict(
            ...
            offline_fields_seen=('observations', 'terminals'),
            online_modules_updated=('encoder', 'actor', 'critic'),
            implementation_notes='OGBench-trained VIP-style temporal value encoder fine-tuned with goal-conditioned DrQ-v2; sparse environment reward only.',
        ),
        'gc_pixel_apv': dict(
            port_kind='goal_conditioned_adaptation',
