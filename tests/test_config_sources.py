...
PAPER_BEST_CONFIGS = {
    ("pbf", "antmaze_medium"): (25, 0.99, 10.0, 0.0, 8, 0.25),
    ("pbf", "antmaze_large"): (25, 0.995, 10.0, 0.0, 32, 0.5),
    ("pbf", "cube_single"): (40, 0.99, 5.0, 0.7, 1, 0.0),
    ("pbf", "cube_double"): (40, 0.99, 10.0, 1.0, 8, 0.25),
    ("pbf", "cube_triple"): (40, 0.995, 10.0, 1.0, 1, 0.0),
    ("pbf", "puzzle_3x3"): (25, 0.99, 10.0, 0.5, 32, 1.0),
    ("pbf", "puzzle_4x4"): (25, 0.99, 10.0, 2.0, 16, 1.0),
    ("pbf", "scene"): (25, 0.99, 5.0, 1.0, 8, 0.5),
    ...
    ("pbg", "puzzle_4x4"): (40, 0.995, 10.0, 2.0, 32, 0.5),
